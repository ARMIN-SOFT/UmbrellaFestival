...
Api.answerCallbackQuery({
callback_query_id: request.id,
text:"🔄منوی جشنواره در حال بار گذاری می باشد...",
show_alert: false
})

let Buttons = [
{title: "🎊جشنواره فعال (۰۱ عدد)", command: "جشنواره فعال" },
{title: "🏠بازگشت به منوی اصلی", command: "داشبورد جشنواره آمبرلا" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "<Sex> [" + FullName + "](tg://user?id=" + UserID + ") به بخش منوی جشنواره خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
