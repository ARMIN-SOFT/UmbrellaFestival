/*CMD
  command: داشبورد جشنواره آمبرلا
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
Api.answerCallbackQuery({
callback_query_id: request.id,
text:"🔄داشبورد جشنواره آمبرلا در حال بار گذاری می باشد...",
show_alert: false
})

let Buttons = [
{title: "🏮منوی جشنواره", command: "منوی جشنواره" },
];

Bot.runCommand("تاریخ و زمان");
Bot.sendInlineKeyboard(Buttons, "<Sex> [" + FullName + "](tg://user?id=" + UserID + ") به بخش داشبورد جشنواره آمبرلا خوش آمدید.\n\n<DateTime>\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.");
